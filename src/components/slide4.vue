...
.app_content .list1 li p{font-size: .28rem;height: .28rem;line-height: .28rem;border-left: .04rem solid #c60000;padding-left: .1rem;margin-top: .14rem;color: #666;}
.app_content img{width: 100%;}
...
.app_content h5{font-weight: normal;font-size: .28rem;color: #333;margin: 0;line-height: .36rem;margin: .08rem 0;}
...
.app_content .news a{font-size: .28rem;color: #666;line-height: .52rem;}
...
.app_content .onfocus p{color: #333;text-align: center;font-size: .28rem;margin: .18rem 0;}
.app_content .navBar{background: #d5d5d5;width: 1.62rem;height: .36rem;margin: 0 auto;border-radius: .08rem;text-align: center;line-height: .36rem;}
